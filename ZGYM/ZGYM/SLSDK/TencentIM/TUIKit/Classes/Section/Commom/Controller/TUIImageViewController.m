...
- (void)viewDidLoad {
    ...
    CGFloat topPadding = StatusBar_Height+NavBar_Height;
    self.imageScrollView.mm_top(topPadding).mm_left(0).mm_width(Screen_Width).mm_height(Screen_Height-topPadding);
//    if (@available(iOS 11.0, *)) {
//        self.imageScrollView.contentInsetAdjustmentBehavior = UIScrollViewContentInsetAdjustmentAutomatic;
//    } else {
...
//    }
    ...
    if (isExist) {
        ...
        _button.backgroundColor = [UIColor sl_hexToAdecimalColorWithHex:@"#5c5c5c"];//[UIColor clearColor];
