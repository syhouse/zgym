...
//        if ([SLPersonDataModel.sharePerson.userModel.type isEqualToString:@"TEACHER"]) {
//            self.messageData.avatarImage = [UIImage imageNamed:@"sl_defult_teacher"];
//        } else {
//            self.messageData.avatarImage = [UIImage imageNamed:@"sl_defult_partent"];
//        }
//
//    } else {
//        if ([SLPersonDataModel.sharePerson.userModel.type isEqualToString:@"TEACHER"]) {
