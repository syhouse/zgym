...
@objc class SLEducationUserModel : NSObject, NSCoding, Mappable{
    ...
    var timestamp : Int?
    var curruntChild: SLChildrenModel?
    var gradeNum : String?
    
	class func newInstance(map: Map) -> Mappable?{
		return SLEducationUserModel()
	}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
        ...
        children = aDecoder.decodeObject(forKey: "children") as? [SLChildrenModel]
