...
class YXSLBXScanNetAnimation: UIImageView {

    var isAnimationing = false
    var animationRect = CGRect.zero

    public static func instance() -> YXSLBXScanNetAnimation {
        return YXSLBXScanNetAnimation()
    }
    ...
    @objc func stepAnimation() {
        ...
        UIView.animate(withDuration: 1.2, animations: {
            ...
            self.perform(#selector(YXSLBXScanNetAnimation.stepAnimation), with: nil, afterDelay: 0.3)
        })
    }
