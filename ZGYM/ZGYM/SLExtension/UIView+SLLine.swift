...
extension UIView{
    @discardableResult
    func sl_addLine(position: LinePosition = .bottom, color: UIColor = kLineColor, leftMargin: CGFloat = 0, rightMargin: CGFloat = 0, lineHeight: CGFloat = 0.5) -> UIView {
        return sl_addLine(position: position, mixedBackgroundColor: MixedColor(normal: color, night: UIColor.sl_hexToAdecimalColor(hex: "#282C3B")), leftMargin: leftMargin, rightMargin: rightMargin, lineHeight: lineHeight)
    }
    
    @discardableResult
    func sl_addLine(position: LinePosition = .bottom, mixedBackgroundColor: MixedColor , leftMargin: CGFloat = 0, rightMargin: CGFloat = 0, lineHeight: CGFloat = 0.5) -> UIView {
