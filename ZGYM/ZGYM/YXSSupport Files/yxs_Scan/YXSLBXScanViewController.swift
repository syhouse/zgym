//
//  YXSLBXScanViewController.swift
//  swiftScan
//
...
public protocol YXSLBXScanViewControllerDelegate: class {
...
open class YXSLBXScanViewController: UIViewController {
    
    // 返回扫码结果，也可以通过继承本控制器，改写该handleCodeResult方法即可
    open weak var scanResultDelegate: YXSLBXScanViewControllerDelegate?
    ...
    open override func viewDidAppear(_ animated: Bool) {
        ...
        drawScanView()
        perform(#selector(YXSLBXScanViewController.startScan), with: nil, afterDelay: 0.3)
    }
...
extension YXSLBXScanViewController: YXSSelectMediaHelperDelegate{
...
//MARK: - 图片选择代理方法
extension YXSLBXScanViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
...
//MARK: - 私有方法
private extension YXSLBXScanViewController {
