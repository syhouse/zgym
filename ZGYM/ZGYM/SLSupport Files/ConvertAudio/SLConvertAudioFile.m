...
@interface SLConvertAudioFile ()
@property (nonatomic, assign) BOOL stopRecord;
@property (nonatomic, assign) BOOL isSleep;
@end

@implementation SLConvertAudioFile

/**
 get instance obj
 
 @return SLConvertAudioFile instance
 */
+ (instancetype)sharedInstance {
    static SLConvertAudioFile *instance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[SLConvertAudioFile alloc] init];
    });
    return instance;
}
