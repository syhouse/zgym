//
//  YXSClassStarTeacherSingleFooterView.swift
//  ZGYM
//
...
class YXSClassStarTeacherSingleFooterView: UITableViewHeaderFooterView {
    ...
    func setFooterModel(_ model: YXSClassStartClassModel?){
        if let model = model{
