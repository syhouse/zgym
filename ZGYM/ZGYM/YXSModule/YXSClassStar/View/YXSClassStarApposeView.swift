...
class YXSClassStarApposeView: UIView {
    ...
    func layout(){
        ...
        titleLabel.yxs_addLine(position: .bottom, leftMargin: 16.5, rightMargin: 20.5, lineHeight: 0.5)
...
extension YXSClassStarApposeView: UITableViewDelegate,UITableViewDataSource{
