//
//  SLBaseClassListTableViewCell.swift
//  ZGYM
//
...
/// 班级列表Cell基类
class SLBaseClassListTableViewCell: SLBaseTableViewCell {//UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        self.contentView.sl_addLine(position: .bottom, mixedBackgroundColor: MixedColor(normal: kTableViewBackgroundColor, night: kNightBackgroundColor), leftMargin: 15, lineHeight: 0.5)
    }
    ...
    /// 成员
    lazy var lbStudentCount: SLLabel = {
        let lb = SLLabel()
        lb.mixedTextColor = MixedColor(normal: kNight898F9A, night: kNight898F9A)
        lb.text = ""
        lb.font = UIFont.systemFont(ofSize: 14)
