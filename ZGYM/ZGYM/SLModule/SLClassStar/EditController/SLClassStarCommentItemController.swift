...
class SLClassStarCommentItemController: SLBaseViewController,UICollectionViewDelegate,UICollectionViewDataSource,JXCategoryListContentViewDelegate {
...
class ClassStarCommentItemCell: UICollectionViewCell {
    ...
    func sl_setCellModel(_ model: SLClassStarCommentItemModel){
        ...
        if model.itemType == .Service{
            ...
            iconImageView.image = UIImage.init(named: "sl_classstar_edit")
            
        }else if model.itemType == .Add{
            iconImageView.image = UIImage.init(named: "sl_classstar_add")
            
        }else{
            iconImageView.image = UIImage.init(named: "sl_classstar_delect")
        }
    ...
    lazy var iconImageView: UIImageView = {
        let imageView = UIImageView.init(image: UIImage.init(named: "sl_classstar_total_class"))
    ...
    lazy var titleLabel: SLLabel = {
        ...
        label.mixedTextColor = MixedColor(normal: UIColor.sl_hexToAdecimalColor(hex: "#575A60"), night: kNight898F9A)
        return label
    }()
