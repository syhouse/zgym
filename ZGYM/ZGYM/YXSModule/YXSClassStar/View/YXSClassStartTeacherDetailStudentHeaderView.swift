//
//  YXSClassStartTeacherDetailStudentHeaderView.swift
//  ZGYM
//
...
class YXSClassStartTeacherDetailStudentHeaderView: UIView {
    let stage: StageType
    ...
    func setHeaderModel(_ model: YXSClassStarChildrenModel){
        self.model = model
