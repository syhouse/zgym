...
let kYXSClassStarTeacherPublishViewReloadDataEvent = "SLClassStarTeacherPublishViewReloadDataEvent"
let kYXSClassStarTeacherPublishViewUpdateCommentButtonEvent = "SLClassStarTeacherPublishViewUpdateCommentButtonEvent"
let kYXSClassStarTeacherPublishViewDoCommentEvent = "SLClassStarTeacherPublishViewDoCommentEvent"
...
//        iconImageView.frame = CGRect(origin: CGPoint.init(x: (itemWidth - 51.0)/2.0, y: 0.0), size: CGSize.init(width: 51, height: 51))
    ...
    func yxs_setCellModel(_ model: SLClassStarChildrenModel){
        self.model = model
