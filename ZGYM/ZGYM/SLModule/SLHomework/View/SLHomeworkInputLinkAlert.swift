//
//  SLHomeworkInputLinkAlert.swift
//  ZGYM
//
...
class SLHomeworkInputLinkAlert: UIView {
    @discardableResult static func showAlert(_ link: String? = nil,compelect:((_ link: String?) ->())? = nil) -> SLHomeworkInputLinkAlert{
        let view = SLHomeworkInputLinkAlert(link)
    ...
    lazy var linkField: SLQSTextField = {
        let classField = UIUtil.sl_getTextField(UIEdgeInsets.init(top: 0, left: 15, bottom: 0, right: 0), placeholder: "请输入网址", placeholderColor: UIColor.sl_hexToAdecimalColor(hex: "#C4CDDA"), mixedTextColor:MixedColor(normal: kTextMainBodyColor, night: kNight898F9A))
...
extension SLHomeworkInputLinkAlert: UITextFieldDelegate{
