...
@interface YXSConvertAudioFile ()
@property (nonatomic, assign) BOOL stopRecord;
@property (nonatomic, assign) BOOL isSleep;
@end

@implementation YXSConvertAudioFile

/**
 get instance obj
 
 @return YXSConvertAudioFile instance
 */
+ (instancetype)sharedInstance {
    static YXSConvertAudioFile *instance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[YXSConvertAudioFile alloc] init];
    });
    return instance;
}
