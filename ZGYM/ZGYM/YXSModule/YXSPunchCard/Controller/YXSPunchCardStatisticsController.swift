...
//        tableHeaderView.setHeaderModel()
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let vc = YXSPunchCardSingleStudentBaseListController.init(isMyPublish: yxs_punchCardModel.promulgator ?? false, type: .studentPunchCardList,clockInId: yxs_punchCardModel.clockInId ?? 0, childrenId: model.childrenId ?? 0)
