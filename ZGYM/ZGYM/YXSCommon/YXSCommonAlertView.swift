...
class YXSCommonAlertView: UIView {
    ...
    @discardableResult @objc static func showAlert(title: String = "", message: String = "", leftTitle: String = "取消",leftTitleColor: UIColor = UIColor.yxs_hexToAdecimalColor(hex: "#797B7E"),leftClick:(() ->())? = nil, rightTitle: String = "确定",rightClick:(() ->())? = nil, superView: UIView! = UIUtil.RootController().view) -> YXSCommonAlertView{
        let view = YXSCommonAlertView.init(title: title, message: message, leftTitle: leftTitle, rightTitle: rightTitle,superView: superView)
    ...
    var rightClick:(() ->())?
    var leftClick:(() ->())?
    init(title: String = "", message: String = "", leftTitle: String = "",leftTitleColor: UIColor = UIColor.yxs_hexToAdecimalColor(hex: "#797B7E"), rightTitle: String = "", superView: UIView!) {
        self.title = title
    ...
    lazy var titleLabel : UILabel = {
        ...
        view.mixedTextColor = MixedColor(normal: UIColor.yxs_hexToAdecimalColor(hex: "#000000"), night: kNight898F9A)
    ...
    lazy var messageLabel : UILabel = {
        ...
        view.mixedTextColor = MixedColor(normal: UIColor.yxs_hexToAdecimalColor(hex: "#575A60"), night: kNight898F9A)
