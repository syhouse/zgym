...
let kYXSFirstLaunchCellGoInEvent = "YXSFirstLaunchCellGoInEvent"

class YXSFirstLaunchCell: UICollectionViewCell {
    ...
    @objc func goInClick(){
        yxs_routerEventWithName(eventName: kYXSFirstLaunchCellGoInEvent)
    }
...
class YXSFirstLaunchController: YXSBaseViewController {
    ...
    lazy fileprivate var collectionView: UICollectionView = {
        ...
        view.register(YXSFirstLaunchCell.self, forCellWithReuseIdentifier: "YXSFirstLaunchCell")
        view.delegate = self
...
extension YXSFirstLaunchController: UICollectionViewDelegate,UICollectionViewDataSource{
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return dataSource.count
    }
    
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "YXSFirstLaunchCell", for: indexPath) as! YXSFirstLaunchCell
...
extension YXSFirstLaunchController:YXSRouterEventProtocol{
    func yxs_user_routerEventWithName(eventName: String, info: [String : Any]?) {
        switch eventName {
        case kYXSFirstLaunchCellGoInEvent:
            yxs_showTabRoot()
        default:
            break
        }
