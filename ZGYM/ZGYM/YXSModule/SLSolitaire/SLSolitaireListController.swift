...
class SLSolitaireListController: YXSCommonScreenListBaseController {
    /// 是否今日事项列表
    ...
    override func viewDidLoad() {
        ...
        tableView.register(SLSolitaireListCell.self, forCellReuseIdentifier: "SLSolitaireListCell")
...
//        YXSCacheHelper.yxs_cacheSolitaireList(dataSource: self.solitaireLists, childrenId: self.yxs_user.curruntChild?.id, isAgent: isAgenda)
    ...
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        ...
        if model.isShowAll{
            if let cacheShowAllHeight = model.cacheShowAllHeight{
                ...
                let height = self.tableView.fd_heightForCell(withIdentifier: "SLSolitaireListCell", cacheByKey: key as NSCopying) { (cell) in
                    if let cell = cell as? SLSolitaireListCell{
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let model = solitaireLists[indexPath.row]
        let cell: SLSolitaireListCell = tableView.dequeueReusableCell(withIdentifier: "SLSolitaireListCell") as! SLSolitaireListCell
