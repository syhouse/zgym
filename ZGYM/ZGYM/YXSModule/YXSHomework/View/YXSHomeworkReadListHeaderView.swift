//
//  YXSHomeworkReadListHeaderView.swift
//  HNYMEducation
//
...
class HomeworkReadCommitListHeaderView: UIView {
    override init(frame: CGRect) {
        ...
        self.yxs_addLine(position: .bottom, color: cl, leftMargin: 0, rightMargin: 0, lineHeight: 10)
    ...
    lazy var progressView: YXSCirleProgressView = {
        let progress = YXSCirleProgressView()
        progress.excircleLineWith = 9
        progress.isShowTitle = false
        progress.isShowRestColor = true
        progress.foregroundColor = UIColor.yxs_hexToAdecimalColor(hex: "#5E88F7")
        progress.restColor = UIColor.yxs_hexToAdecimalColor(hex: "#E6EAF3")
