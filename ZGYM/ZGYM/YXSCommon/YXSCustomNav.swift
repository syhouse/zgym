...
let kYXSCustomNavBackEvent = "YXSCustomNavBackEvent"
let kYXSCustomNavShareEvent = "YXSCustomNavShareEvent"
let kYXSCustomNavMoreEvent = "YXSCustomNavMoreEvent"

enum YXSCustomStyle: Int{
    case onlyback
    case backAndTitle
    case backAndTitleAndRight
}

class YXSCustomNav: UIView{
    init(_ style: YXSCustomStyle = .backAndTitleAndRight) {
...
//            }
    ...
    @objc func onBackClick(){
        yxs_routerEventWithName(eventName: kYXSCustomNavBackEvent)
    }
    @objc func shareClick(){
        yxs_routerEventWithName(eventName: kYXSCustomNavShareEvent)
    }
    @objc func moreClick(){
        yxs_routerEventWithName(eventName: kYXSCustomNavMoreEvent)
    }
    ...
    lazy var shareButton: UIButton = {
        ...
        button.setImage(UIImage(named: "yxs_punchCard_share"), for: .normal)
        return button
    }()
    ...
    lazy var moreButton: UIButton = {
        ...
        button.setImage(UIImage(named: "yxs_homework_more"), for: .normal)
        return button
    }()
