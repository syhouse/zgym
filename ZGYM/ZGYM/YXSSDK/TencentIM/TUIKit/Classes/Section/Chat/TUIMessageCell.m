...
//        if ([YXSPersonDataModel.sharePerson.userModel.type isEqualToString:@"TEACHER"]) {
//            self.messageData.avatarImage = [UIImage imageNamed:@"yxs_defult_teacher"];
//        } else {
//            self.messageData.avatarImage = [UIImage imageNamed:@"yxs_defult_partent"];
//        }
//
//    } else {
//        if ([YXSPersonDataModel.sharePerson.userModel.type isEqualToString:@"TEACHER"]) {
