...
@interface YXSAddressPickerModel()
...
@implementation YXSAddressPickerModel
+ (instancetype)shareInstance {
    static dispatch_once_t onceToken;
    static YXSAddressPickerModel *_instance = nil;
    dispatch_once(&onceToken, ^{
        _instance = [[YXSAddressPickerModel alloc] init];
    });
    return _instance;
}
