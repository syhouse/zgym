//
//  SLMineMessageNoticeViewController.swift
//  ZGYM
//
...
class SLMineMessageNoticeViewController: SLBaseTableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.contentView.sl_addLine(position: .bottom, color: kLineColor, leftMargin: 15, rightMargin: 0, lineHeight: 0.5)
