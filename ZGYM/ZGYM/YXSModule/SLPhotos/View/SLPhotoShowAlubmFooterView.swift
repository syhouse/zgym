//
//  SLPhotoShowAlubmFooterView.swift
//  HNYMEducation
//
...
let kYXSPhotoShowAlubmFooterViewMoreEventKey = "SLPhotoShowAlubmFooterViewMoreEventKey"

class SLPhotoShowAlubmFooterView: UIView {
    var model: SLPhotoAlbumsPraiseModel!
...
//        64 +
    ...
    func setModel(model: SLPhotoAlbumsPraiseModel){
        self.model = model
