...
//        button.setTitleColor(UIColor.sl_hexToAdecimalColor(hex: "#898F9A"), for: .disabled)
    }
    ...
    lazy var photoCountButton: UIButton = {
        ...
        button.setBackgroundImage(UIImage.sl_image(with: UIColor.sl_hexToAdecimalColor(hex: "#E1EBFE")), for: .normal)
        button.setBackgroundImage(UIImage.sl_image(with: UIColor.sl_hexToAdecimalColor(hex: "#E6E9F0")), for: .disabled)
...
class SLPhotoClassListController: SLBaseTableViewController {
...
//        view.button.sl_gradualBackground(frame: CGRect.init(x: 0, y: 0, width: SCREEN_WIDTH - 57, height: 49), startColor: UIColor.sl_hexToAdecimalColor(hex: "#4B73F6"), endColor: UIColor.sl_hexToAdecimalColor(hex: "#77A3F8"), cornerRadius: 24.5)
//        view.button.sl_shadow(frame: CGRect.init(x: 0, y: 0, width: SCREEN_WIDTH - 57, height: 49), color: UIColor(red: 0.3, green: 0.45, blue: 0.96, alpha: 0.5), cornerRadius:  24.5, offset: CGSize(width: 0, height: 3))
//        return view
//    }
    // MARK: - getter&setter
}
