...
- (void)viewDidLoad {
    ...
    NSDictionary *videoDic = [[NSUserDefaults standardUserDefaults] dictionaryForKey:SLPersonDataModel.sharePerson.userModel.account];
    ...
    if (videoPath.length) {
        ...
        [self downLoadWithURL:self.videoUrl fileDir:@"videoURLPath/" success:^(NSString *path) {
            ...
            if (pathArray.count > 1) {
                ...
                [[NSUserDefaults standardUserDefaults] setObject:mutDic.copy forKey:SLPersonDataModel.sharePerson.userModel.account];
...
+ (void)clearVideoCache {
    ...
    [[NSUserDefaults standardUserDefaults] setObject:videoDic forKey:SLPersonDataModel.sharePerson.userModel.account];
