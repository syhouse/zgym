//
//  YXSClassStarSignleClassDetialController.swift
//  ZGYM
//
...
class YXSClassStarTeacherSignleClassDetialController: YXSClassStarSignleClassBaseController {
    ...
    func tableView(_ tableView: UITableView, viewForFooterInSection section: Int) -> UIView? {
        let footer: YXSClassStarTeacherSingleFooterView = tableView.dequeueReusableHeaderFooterView(withIdentifier: "YXSClassStarTeacherSingleFooterView") as! YXSClassStarTeacherSingleFooterView
    ...
    // MARK: - getter&setter
    lazy var tableHeaderView: YXSClassStarTeacherDetialHeaderView = {
        let tableHeaderView = YXSClassStarTeacherDetialHeaderView.init(frame: CGRect.init(x: 0, y: 0, width: SCREEN_WIDTH, height: 0),stage: classModel?.stageType ?? StageType.KINDERGARTEN)
...
extension YXSClassStarTeacherSignleClassDetialController{
    override func yxs_user_routerEventWithName(eventName: String, info: [String : Any]?) {
        ...
        case kYXSClassStarTeacherDetialHeaderViewLookDetialEvent:
            let vc = YXSClassStarDetailListController.init(classModel: classModel!)
            navigationController?.pushViewController(vc)
        default:
            break
        }
