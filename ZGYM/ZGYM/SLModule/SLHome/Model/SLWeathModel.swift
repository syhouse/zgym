...
//  ZGYM
//
//  Created by hnsl_mac on 2019/12/24.
...
class SLWeathModel : NSObject,NSCoding , Mappable{
    var air : String?
    var airLevel : String?
    var airPm25 : String?
    var airTips : String?
    ...
    var isToDay: Bool{
        get {
            return curruntRequestData == nil ? false : NSUtil.sl_isSameDay(curruntRequestData ?? Date(), date2: Date())
        }
    }
