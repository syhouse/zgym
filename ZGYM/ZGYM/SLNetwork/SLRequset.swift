...
class SLEducationVersionManageLatestRequest: SLBaseRequset {
    override init() {
        super.init()
        method = .post
...
class SLEducationTencentImUserSignRequest: SLBaseRequset {
    override init() {
        super.init()
        method = .post
...
class SLEducationUserEditRequest: SLBaseRequset {
...
//class SLEducationUserEditRequest: HMBaseRequset {
...
// MARK: -发送短信验证码
class SLEducationSmsSendRequest: SLBaseRequset {
...
class SLEducationUserLoginSmsSendRequest: SLBaseRequset {
...
class SLEducationUserRegisterRequest: SLBaseRequset {
...
class SLEducationUserLoginPasswordRequest: SLBaseRequset {
...
class SLEducationUserForgetPasswordRequest: SLBaseRequset {
...
class SLEducationUserChooseTypeRequest: SLBaseRequset {
...
class SLEducationUserSwitchStageRequest: SLBaseRequset {
...
class SLEducationUserSetPasswordRequest: SLBaseRequset {
...
class SLEducationUserSwitchTypeRequest: SLBaseRequset {
...
class SLEducationGradeCreateRequest: SLBaseRequset {
...
class SLEducationGradeListRequest: SLBaseRequset {
    override init() {
        super.init()
        isLoadCache = true
        method = .post
...
class SLEducationGradeQueryRequest: SLBaseRequset {
    init(num: String) {
        super.init()
        method = .post
        path = gradeQuery
...
class SLEducationGradeQuitRequest: SLBaseRequset {
    init(gradeId: Int, childrenIds: [Int]?,smsCode:Int) {
        super.init()
        method = .post
        path = gradeQuit
        if childrenIds == nil {
            param = ["gradeId": gradeId, "smsCode":smsCode]
            
        } else {
            param = ["gradeId": gradeId, "childrenIds": childrenIds, "smsCode":smsCode]
        }
...
class SLEducationGradeOutRequest: SLBaseRequset {
...
class SLEducationGradeOptionalChildrenListRequest: SLBaseRequset {
    init(gradeId: Int) {
        super.init()
        method = .post
...
class SLEducationGradeDetailRequest: SLBaseRequset {
    init(gradeId: Int) {
        super.init()
        method = .post
        path = gradeDetail
...
class SLEducationGradeUpdateRequest: SLBaseRequset {
    init(dic:[String: Any]) {
        super.init()
        method = .post
        path = gradeUpdate
...
class SLEducationGradeOptionalTeacherListRequest: SLBaseRequset {
    init(gradeId: Int) {
        super.init()
        method = .post
...
class SLEducationGradeTransferRequest: SLBaseRequset {
...
class SLEducationGradeMemberDetailRequest: SLBaseRequset {
    init(gradeId: Int) {
        super.init()
        method = .post
...
class SLEducationGradeMemberJoinRequest: SLBaseRequset {
...
class SLEducationGradeMemberChildrenListRequest: SLBaseRequset {
    init(gradeId: Int) {
        super.init()
        method = .post
...
class SLEducationOssAuthTokenRequest: SLBaseRequset {
    override init() {
        super.init()
        host = ossHost
        method = .post
...
class SLEducationChildrenListRequest: SLBaseRequset {
    override init() {
        super.init()
        method = .post
//        host = homeHost
...
class SLEducationChildrenDeleteRequest: SLBaseRequset {
    init(id: Int) {
        super.init()
        method = .post
//        host = homeHost
...
class SLEducationChildrenUpdateRequest: SLBaseRequset {
    init(parameter: [String:String]) {
        super.init()
        method = .post
        path = childrenUpdate
...
class SLEducationFeedbackSubmitRequest: SLBaseRequset {
    init(content: String) {
        super.init()
        method = .post
        path = feedbackSubmit
...
class SLEducationComplaintSubmitRequest: SLBaseRequset {
...
class SLEducationShareLinkRequest: SLBaseRequset {
