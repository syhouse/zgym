...
class BaseYMClassManageTableViewCell: SLBaseTableViewCell {//UITableViewCell {
...
class SLClassManageTableViewCell: BaseYMClassManageTableViewCell {
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        super.init(style: style, reuseIdentifier: reuseIdentifier)
...
class ClassManageSwitchTableViewCell: BaseYMClassManageTableViewCell {
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        super.init(style: style, reuseIdentifier: reuseIdentifier)
...
class ClassManageSubTitleTableViewCell: BaseYMClassManageTableViewCell {
