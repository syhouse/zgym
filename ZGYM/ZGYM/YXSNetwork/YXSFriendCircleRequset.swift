...
class YXSEducationClassOptionalGradeListRequest: YXSBaseRequset {
    override init() {
        super.init()
        method = .post
...
class YXSEducationClassCircleCancelRequest: YXSBaseRequset {
...
/// 点赞或取消点赞班级圈
class YXSEducationClassCirclePraiseUpdateRequest: YXSBaseRequset {
    init(classCircleId: Int) {
        super.init()
        method = .post
...
//COMMENT评论 REPLY回复
class YXSEducationClassCircleCommentSaveRequest: YXSBaseRequset {
...
//id 评论id
class YXSEducationClassCircleCommentCancelRequest: YXSBaseRequset {
...
class YXSEducationClassCircleTimeAxisPageRequest: YXSBaseRequset {
...
class YXSEducationClassCirclePublishRequest: YXSBaseRequset {
...
class YXSEducationClassCircleUserInfoRequest: YXSBaseRequset {
...
class YXSEducationClassCircleMessageListRequest: YXSBaseRequset {
    override init() {
        super.init()
        method = .post
...
class YXSEducationClassCircleMessageTipsRequest: YXSBaseRequset {
    override init(){
        super.init()
        method = .post
...
class YXSEducationClassCircleTimeAxisDetailRequest: YXSBaseRequset {
    init(classCircleId: Int){
        super.init()
        method = .post
