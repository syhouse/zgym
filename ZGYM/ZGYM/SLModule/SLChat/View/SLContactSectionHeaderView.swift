//
//  SLContactSectionHeaderView.swift
//  ZGYM
//
...
/// 联系人组头部
class SLContactSectionHeaderView: UITableViewHeaderFooterView {
    ...
    var model: SLContactSectionHeaderViewModel? {
        didSet {
...
class SLContactSectionHeaderViewModel: NSObject {
