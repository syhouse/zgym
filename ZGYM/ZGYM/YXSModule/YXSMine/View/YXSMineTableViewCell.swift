...
class YXSMineTableViewCell: YXSBaseTableViewCell {
...
//            self.contentView.yxs_addLine(position: LinePosition.bottom, leftMargin: 15, rightMargin: 15)
//        }
    }
    ...
    lazy var redDot: UIView = {
        ...
        view.isHidden = true
        view.cornerRadius = 6
        view.backgroundColor = UIColor.yxs_hexToAdecimalColor(hex: "#E8534C")
        return view
    }()
