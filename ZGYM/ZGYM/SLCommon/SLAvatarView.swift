...
/// 头像+标题+副标题
class SLAvatarView: UIView {
//    private var avatarH:CGFloat = 42
    private var style:SLAvatarViewStyle = .TitleOnly
    
    init(style:SLAvatarViewStyle = .TitleSubTitle) {
...
/// 头像+标题+副标题+圆角按钮
class SLAvatarContactView: SLAvatarView {
    init() {
...
//        let view = SLAvatarView(style: .TitleSubTitle)
//        return view
//    }()
//
