...
class SLProfileTableViewCell: SLBaseTableViewCell {
...
//        cellStyle = .SubTitle
        self.contentView.sl_addLine(position: LinePosition.bottom, color: kLineColor, leftMargin: 15, rightMargin: 0, lineHeight: 0.5)
    }
