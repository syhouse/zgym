...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        self.colorWhenTouched = [UIColor redColor];
...
- (void)layoutSubviews
{
    ...
    CGFloat value = TConversationCell_Margin + 4 + self.timeLabel.frame.size.width + 10;
    self.titleLabel.mm_sizeToFitThan(120, 30).mm_top(TConversationCell_Margin_Text - 5).mm_left(self.headImageView.mm_maxX+TConversationCell_Margin).mm_flexToRight(value);
...
//    self.subTitleLabel.mm_sizeToFit().mm_left(self.titleLabel.mm_x).mm_bottom(TConversationCell_Margin_Text).mm_flexToRight(self.mm_w-self.unReadView.mm_x);
    self.unReadView.mm_left(TConversationCell_Margin + 3 + imgHeight - 18).mm_top(TConversationCell_Margin-6);
    self.subTitleLabel.mm_sizeToFit().mm_left(self.titleLabel.mm_x).mm_bottom(TConversationCell_Margin_Text).mm_flexToRight(TConversationCell_Margin_Text);
}
