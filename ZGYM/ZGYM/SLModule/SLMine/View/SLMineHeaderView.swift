//
//  SLMineHeaderView.swift
//  ZGYM
//
//  Created by sl_mac on 2019/12/5.
...
//        self.addSubview(imgBG)
    ...
    func refreshData() {
        btnAvatar.sl_setImage(with: URL(string: self.sl_user.avatar ?? ""), for: .normal, placeholderImage: kImageUserIconTeacherDefualtMixedImage)
        btnAvatar.sl_setImage(with: URL(string: self.sl_user.avatar ?? ""), for: .highlighted, placeholderImage: kImageUserIconTeacherDefualtMixedImage)
        lbName.text = self.sl_user.name ?? ""
        
        if SLPersonDataModel.sharePerson.personRole == .TEACHER {
            lbSubTitle.text = self.sl_user.school ?? "暂无学校"
        } else {
            if (self.sl_user.children?.count ?? 0) > 0 {
                lbSubTitle.text = "共\((self.sl_user.children?.count ?? 0))个孩子"
            } else {
            ...
            for index in 0..<(self.sl_user.children ?? [SLChildrenModel]()).count{
                arr.append(self.sl_user.children![index].avatar ?? "")
            }
...
//        let img = UIImageView()
//        img.mixedImage = MixedImage(normal: "sl_mine_header_bg", night: "sl_mine_header_bg_night")
//        return img
//    }()
...
//        view.sl_gradualBackground(frame: CGRect(x: 0, y: 0, width: SCREEN_WIDTH-30, height: (SCREEN_WIDTH-30)*70/345), startColor: UIColor.sl_hexToAdecimalColor(hex: "#000000"), endColor: UIColor.sl_hexToAdecimalColor(hex: "#000000"), cornerRadius: 5)
//        view.sl_shadow(frame: CGRect(x: 0, y: 0, width: SCREEN_WIDTH-30, height: (SCREEN_WIDTH-30)*70/345), color: UIColor.sl_hexToAdecimalColor(hex: "#181A23"), cornerRadius: 5, offset: CGSize(width: 0, height: 2))
        return view
    }()
    
    
    lazy var btnAvatar: SLButton = {
        let btn = SLButton()
        if SLPersonDataModel.sharePerson.personRole == .TEACHER {
    ...
    lazy var btnEdit: SLButton = {
        let btn = SLButton()
//        btn.setImage(UIImage(named: "sl_mine_edit"), for: .normal)
...
//    lazy var btnChangeStage: SLButton = {
//        let btn = SLButton()
//        btn.setTitle("切换学段", for: .normal)
//        btn.titleLabel?.font = UIFont.systemFont(ofSize: 14)
//        btn.setMixedTitleColor(MixedColor(normal: 0x575A60, night: 0xEB9A3C), forState: .normal)
//        btn.setBackgroundImage(UIImage(named: "sl_mine_stage"), for: .normal)
//        btn.isHidden = SLPersonDataModel.sharePerson.personRole == .TEACHER ? false : true
//        return btn
//    }()
//
...
////        view.sl_gradualBackground(frame: CGRect(x: 0, y: 0, width: SCREEN_WIDTH-30, height: (SCREEN_WIDTH-30)*55/345), startColor: UIColor.sl_hexToAdecimalColor(hex: "#20232F"), endColor: UIColor.sl_hexToAdecimalColor(hex: "#20232F"), cornerRadius: 5)
////        view.sl_shadow(frame: CGRect(x: 0, y: 0, width: SCREEN_WIDTH-30, height: (SCREEN_WIDTH-30)*55/345), color: UIColor.sl_hexToAdecimalColor(hex: "#181A23"), cornerRadius: 5, offset: CGSize(width: 0, height: 2))
//        return view
//    }()
    
//    lazy var btnMyClass: SLButton = {
//        let btn = SLButton()
//        btn.setTitle("我的班级", for: .normal)
//        btn.setImage(UIImage(named: "sl_mine_house"), for: .normal)
...
//    lazy var btnClass: SLButton = {
//        let btn = SLButton()
//        btn.setTitle("我的班级", for: .normal)
//        btn.setImage(UIImage(named: "sl_mine_class"), for: .normal)
//        btn.titleLabel?.font = UIFont.systemFont(ofSize: 15)
...
//    }()
//
//    lazy var btnMyComment: SLButton = {
//        let btn = SLButton()
//        btn.setTitle("我的点评", for: .normal)
//        btn.setImage(UIImage(named: "sl_mine_comment"), for: .normal)
//        btn.titleLabel?.font = UIFont.systemFont(ofSize: 15)
...
//        btn.layer.borderColor = UIColor.sl_hexToAdecimalColor(hex: "#5E88F7").cgColor
...
class ImagesStackingView: UIControl {//UIView {
    ...
    @objc func layout(imagesUrl:[String]) {
        ...
        for idx in 0 ..< (self.imagesUrl ?? [String]()).count{
            ...
            let placeholderImg = SLPersonDataModel.sharePerson.personRole == .TEACHER ? kImageUserIconTeacherDefualtMixedImage : kImageUserIconStudentDefualtMixedImage
            let url = self.imagesUrl![idx]
            img.sl_setImageWithURL(url:  URL(string: url), placeholder: placeholderImg)
            self.addSubview(img)
