...
- (void)configCustomNaviBar
{
    ...
    if (self.isShowClearReductionBtn) {
        ...
        [_clear_reductionButton setTitleColor:self.oKButtonTitleColorNormal forState:UIControlStateNormal];
...
- (void)reductionButtonClick {
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"确定要清除该图片的涂鸦？" message:@"" preferredStyle:UIAlertControllerStyleAlert];
    [alert addAction:[UIAlertAction actionWithTitle:@"确定" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        if (self.clearReductionBlock) {
            self.clearReductionBlock();
        }
    }]];
