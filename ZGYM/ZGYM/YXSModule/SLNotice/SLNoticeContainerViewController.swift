...
class SLNoticeContainerViewController: YXSBaseViewController, JXCategoryViewDelegate, JXCategoryListContainerViewDelegate {
...
extension SLNoticeContainerViewController: YXSRouterEventProtocol{
