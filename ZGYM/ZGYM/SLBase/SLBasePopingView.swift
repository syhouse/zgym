...
class SLBasePopingView: UIView, UIGestureRecognizerDelegate {
    ...
    lazy var panelView: UIView = {
        let mask = UIView()
        mask.mixedBackgroundColor = MixedColor(normal: UIColor(white: 0.1, alpha: 0.7), night: UIColor.sl_hexToAdecimalColor(hex: "#383E56", alpha: 0.7))
