...
class YXSScoreReadingListVC: YXSBaseTableViewController, JXCategoryListContentViewDelegate {
    var sectionHeader: YXSHomeworkReadListSectionHeader?
    var selectedListDataIndex: Int = 0
    var homeListModel: YXSScoreListModel?
