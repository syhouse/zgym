...
class  YXSPunchCardCommentModel: NSObject, NSCoding, Mappable{
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
    {
         ...
         ruserId = aDecoder.decodeObject(forKey: "ruserId") as? Int
         ruserName = aDecoder.decodeObject(forKey: "ruserName") as? String
         ruserType = aDecoder.decodeObject(forKey: "ruserType") as? String
    ...
    */
    @objc func encode(with aCoder: NSCoder)
    {
        ...
        if ruserId != nil{
            aCoder.encode(ruserId, forKey: "ruserId")
        }
        if ruserName != nil{
            aCoder.encode(ruserName, forKey: "ruserName")
        }
        if ruserType != nil{
            aCoder.encode(ruserType, forKey: "ruserType")
        }
        if type != nil{
