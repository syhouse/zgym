...
class SLClassStarDetailListController: SLClassStarSignleClassCommonController {
    ...
    @objc func yxs_loadClassChildrensData(){
        YXSEducationClassStarTeacherClassChildrenTopRequest.init(classId: classModel.classId ?? 0, dateType: classModel.dateType).requestCollection({ (list:[SLClassStarChildrenModel]) in
