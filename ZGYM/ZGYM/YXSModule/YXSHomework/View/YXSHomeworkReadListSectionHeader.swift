//
//  YXSHomeworkReadListSectionHeader.swift
//  ZGYM
//
...
class YXSHomeworkReadListSectionHeader: UITableViewHeaderFooterView {
    ...
    */
    ...
    var alertClick:((_ view:YXSButton)->())?
    var commentClick:((_ view:YXSButton)->())?
...
//    var selectedIndex:Int = 0
    ...
    // MARK: - Action
    @objc func titleButtonClick(sender:YXSButton) {
    ...
    @objc func commentClick(sender: YXSButton) {
           commentClick?(sender)
    }
