//
//  YXSClassMembersTableViewCell.swift
//  ZGYM
//
...
class YXSClassMembersTableViewCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        contentView.yxs_addLine(position: .bottom, mixedBackgroundColor: MixedColor(normal: kTableViewBackgroundColor, night: kNightBackgroundColor), leftMargin: 15, lineHeight: 0.5)
    }
    ...
    lazy var imgAvatar: UIImageView = {
        ...
        img.backgroundColor = UIColor.yxs_hexToAdecimalColor(hex: "#D6E3FD")
