...
class SLHomeworkDetailCommentView: UIView {
    ...
    */
    ...
    lazy var lbCommentTime: SLLabel = {
        let lb = SLLabel()
        lb.text = "刚刚"
    ...
    lazy var commetAudioView: SLVoiceView = {
...
class SLHomeworkDetailCommentViewModel: NSObject {
    var title: String?
    var comment: String?
    var time: String?
    var audioModel: SLVoiceViewModel?
