//
//  YXSClassStarTeacherSingleCell.swift
//  ZGYM
//
...
class YXSClassStarTeacherSingleCell: UITableViewCell {
    ...
    func yxs_setCellModel(_ model: YXSClassStarHistoryModel){
        self.model = model
...
//        kNightForegroundColor
    ...
    func yxs_setCellModel(_ model: YXSClassStartTeacherModel){
