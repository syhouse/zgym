...
class YXSEventCopyLabel: YXSLabel {
...
//            self.backgroundColor = UIColor.clear
            ...
            self.mixedBackgroundColor = MixedColor(normal: UIColor.yxs_hexToAdecimalColor(hex: "#EAE9E9"), night: UIColor.yxs_hexToAdecimalColor(hex: "#505050"))
//            self.backgroundColor = UIColor.yxs_hexToAdecimalColor(hex: "#EAE9E9")
            setMenuItems()
        }
    }
