//
//  SLNoticeContainerViewController.swift
//  ZGYM
//
...
class SLNoticeContainerViewController: SLBaseViewController, JXCategoryViewDelegate, JXCategoryListContainerViewDelegate {
    ...
    var secondTableView: SLNoticeReplyListViewController!
...
//        secondTableView = SLNoticeReplyListViewController()
    ...
    func refreshData() {
        ...
        SLEducationNoticeQueryCommitReadInfoRequest(noticeId: detailModel?.serviceId ?? 0, gradeId: detailModel?.classId ?? 0, noticeCreateTime: detailModel?.createTime ?? "").request({ [weak self](json) in
            ...
            weakSelf.secondTableView.SLHomeListModel = weakSelf.detailModel
...
extension SLNoticeContainerViewController: SLRouterEventProtocol{
