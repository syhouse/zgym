//
//  SLPublishHomeworkSucessView.swift
//  ZGYM
//
...
class SLPublishHomeworkSucessView: UIView {
    @discardableResult @objc static func showAlert(compelect: @escaping (() ->())) -> SLPublishHomeworkSucessView{
        let view = SLPublishHomeworkSucessView()
    ...
    lazy var publishSucessImage: UIImageView = {
        ...
        imageView.mixedImage = MixedImage(normal: "sl_publish_sucess_bg", night: "sl_publish_sucess_bg_night")
        return imageView
    }()
    ...
    lazy var desLabel : UILabel = {
        ...
        view.mixedTextColor = MixedColor(normal: UIColor.sl_hexToAdecimalColor(hex: "#C4CDDA"), night: kNightBCC6D4)
    ...
    lazy var certainButton : SLButton = {
        ...
        button.sl_gradualBackground(frame: CGRect.init(x: 0, y: 0, width: 200, height: 49), startColor: UIColor.sl_hexToAdecimalColor(hex: "#4B73F6"), endColor: UIColor.sl_hexToAdecimalColor(hex: "#77A3F8"), cornerRadius: 24.5)
        button.addShadow(ofColor: UIColor.sl_hexToAdecimalColor(hex: "#4C74F6"), radius: 7.5, offset: CGSize(width: 0, height: 3), opacity: 0.5)
