...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (data.identifier) {
        ...
        if (SLChatHelper.sharedInstance.isNightTheme) {
            data.avatarImage = [data.identifier containsString:@"TEACHER"] ? [UIImage imageNamed:@"sl_defult_teacher_night"] : [UIImage imageNamed:@"sl_defult_partent_night"];
            
        } else {
            data.avatarImage = [data.identifier containsString:@"TEACHER"] ? [UIImage imageNamed:@"sl_defult_teacher"] : [UIImage imageNamed:@"sl_defult_partent"];
        }
    }
...
- (void)sendMessage:(TUIMessageCellData *)msg
{
    ...
    msg.identifier = selfProfile.identifier;
