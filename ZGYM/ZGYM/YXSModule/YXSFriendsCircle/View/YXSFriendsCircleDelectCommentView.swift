//
//  YXSFriendsCircleDelectCommentView.swift
//  ZGYM
//
...
class YXSFriendsCircleDelectCommentView: UIView {
    @discardableResult static func showAlert(_ point: CGPoint,compelect:(() ->())? = nil) -> YXSFriendsCircleDelectCommentView{
        let view = YXSFriendsCircleDelectCommentView(point)
