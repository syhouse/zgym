...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (data.identifier) {
        ...
        if (YXSChatHelper.sharedInstance.isNightTheme) {
            data.avatarImage = [data.identifier containsString:@"TEACHER"] ? [UIImage imageNamed:@"yxs_defult_teacher_night"] : [UIImage imageNamed:@"yxs_defult_partent_night"];
            
        } else {
            data.avatarImage = [data.identifier containsString:@"TEACHER"] ? [UIImage imageNamed:@"yxs_defult_teacher"] : [UIImage imageNamed:@"yxs_defult_partent"];
        }
    }
