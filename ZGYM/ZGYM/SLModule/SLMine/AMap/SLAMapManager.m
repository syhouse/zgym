...
@implementation SLAMapManager
+ (instancetype)shareManager {
    static dispatch_once_t onceToken;
    static SLAMapManager *_instance = nil;
    dispatch_once(&onceToken, ^{
        _instance = [[SLAMapManager alloc] init];
    });
    return _instance;
}

- (void)configured {
    [AMapServices sharedServices].apiKey = @"2e0e5963ea94aa0b4b59f547cd848085";
