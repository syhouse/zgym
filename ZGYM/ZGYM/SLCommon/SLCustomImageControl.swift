...
class SLCustomImageControl: UIControl {
    /// 图片位置
    private var position: SLImagePositionType
    ...
    init(imageSize: CGSize = CGSize.init(width: 16, height: 16), position: SLImagePositionType = .right, padding: CGFloat = 10, insets: UIEdgeInsets = UIEdgeInsets.init(top: 0, left: 0, bottom: 0, right: 0)) {
